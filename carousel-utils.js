export function getCardMetrics(root) {
...
export function getViewportMetrics(viewport, step) {
...
export function indexToScrollLeft(index, metrics) {
...
export function scrollLeftToIndex(scrollLeft, metrics) {
...
export function getSpacerWidths(params) {
  const {
    renderStart = 0,
    renderEnd = 0,
    totalCount = 0,
